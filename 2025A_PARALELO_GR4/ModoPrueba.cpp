...
// Dirección del foco (hacia donde apunta la luz)
glm::vec3 spotlightDir(0.0f, 0.0f, -1.0f);  // Apuntando hacia adelante

// Ángulo de corte (debe estar entre 0 y 1, donde 0 es totalmente concentrado)
float spotlightCutoff = glm::cos(glm::radians(12.5f));   // Ángulo de corte para el spotlight
float spotlightOuterCutoff = glm::cos(glm::radians(17.5f)); // Ángulo de atenuación exterior
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setVec3("lightDirection", spotlightDir);  // Dirección de los focos
        ourShader.setFloat("cutoff", spotlightCutoff);  // Ángulo de corte
        ourShader.setFloat("outerCutoff", spotlightOuterCutoff); // Ángulo de atenuación exterior
